...
namespace AmbarPPC
{
	...
	/// </summary>
	public class MalHazirla : System.Windows.Forms.Form
	{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MalHazirla));
            ...
            this.Name = "MalHazirla";
            this.Text = "Mal Hazirlama";
		...
		private void textBoxSiparisNo_KeyUp(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			if(e.KeyCode == Keys.Enter)
			{
                ...
                {
                    Utility.Hata("Uygulama versiyonu eski olduðu için uygulama katýlacaktýr. Lütfen tekrar giriþ yapýnýz.");
                    Application.Exit();
                    return;
                }
                else if(string.IsNullOrEmpty(versiyon))
                {
                    Utility.Dikkat("Veritabanýndan versiyon bilgisi okunamadýðý için iþleme devam edilemiyor. Daha sonra tekrar deneyiniz.");
...
ORDER BY sevk_emri.EmirNo",textBoxCariAdi.Text.ToUpper());
		...
		private void button3_Click(object sender, System.EventArgs e)
		{
			...
			{
                Cursor.Current = Cursors.WaitCursor;
                MalHazirlamaDetay dt = new MalHazirlamaDetay();
